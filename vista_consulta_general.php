...
<div class="page-header">
    <h1>Tabla de Turnos <small>Consulta General</small></h1>
</div>
...
<div class="card fade-in">
    ...
    <div class="card-body">
        ...
        <div class="table-controls">
            ...
            <a class="btn btn-export btn-pdf" href="registrosPDF/imprimir_registro_cg_pdf.php" target="_blank">
                <i class="fas fa-file-pdf"></i> Exportar a PDF
            </a>
            <a class="btn btn-export btn-excel" href="registrosExcel/imprimir_registro_cg_excel.php">

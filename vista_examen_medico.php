...
$sql = $conexion->prepare("SELECT turnos.id AS id_turno, usuarios.cedula AS cedula, fecha_cita, hora_cita, nota_adicional,estado,estado,usuarios.nombre AS nombre_paciente, usuarios.email AS email_paciente FROM turnos INNER JOIN servicios ON turnos.servicio_id = servicios.id INNER JOIN usuarios ON turnos.usuario_id = usuarios.id WHERE turnos.servicio_id = 3");
$sql->execute();
...
<div class="page-header">
    <h1>Tabla de Turnos <small>Examenes Medicos Generales</small></h1>
</div>
...
<div class="card fade-in">
    ...
    <div class="card-body">
        ...
        <div class="table-controls">
            ...
            <a class="btn btn-export btn-pdf" href="registrosPDF/imprimir_registro_me_pdf.php" target="_blank">
                <i class="fas fa-file-pdf"></i> Exportar a PDF
            </a>
            <a class="btn btn-export btn-excel" href="registrosExcel/imprimir_registro_me_excel.php">
